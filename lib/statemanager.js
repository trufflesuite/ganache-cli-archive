...
StateManager = function(options) {
  ...
  this.blockchain = options.blockchain || new BlockchainDouble(options);

  // TODO: Refactor these two lines out.
...
StateManager.prototype.processNextAction = function(override) {
  ...
  if (queued.method == "eth_getStorageAt") {
    this.blockchain.getStorage(queued.address, queued.position, queued.block, intermediary);
