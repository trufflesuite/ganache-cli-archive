...
Manager.prototype.eth_estimateGas = function(tx_data, callback) {
  this.blockchain.queueEstimateGas(tx_data, callback);
};
...
Manager.prototype.eth_sendRawTransaction = function(rawTx, callback) {
  ...
  this.eth_sendTransaction(txParams, callback);
};
