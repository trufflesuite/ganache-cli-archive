...
Manager.prototype.increaseTime = function(seconds) {
  this.blockchain.increaseTime(seconds || 0);
}
...
Manager.prototype.eth_syncing = function(callback) {
  callback(null, false);
};
...
Manager.prototype.net_peerCount = function(callback) {
  callback(null, 0);
};
...
Manager.prototype.net_version = function(callback) {
