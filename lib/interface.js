  ...
  ipcServer: function(options) {
    ...
    var server = net.createServer(function(socket) {
      ...
      socket.on('data', function(data) {
        ...
        try {
          ...
          // NOTE: some clients expect the trailing new line
          socket.write('{"jsonrpc": "2.0", "id": null, "error": {"code": -32700, "message": "Bad request"}}\n');
          return;
        }
    ...
    return {
      listen: function (port, hostname, callback) {
        ...
        provider.manager.waitForInitialization(function(err, accounts) {
          callback(err, accounts);
        });
      }
    }
