...
GethApiDouble.prototype.rpc_modules = function(callback) {
  ...
  callback(null, {"eth":"1.0","net":"1.0","rpc":"1.0","web3":"1.0","evm":"1.0","bzz":"1.0"});
};

GethApiDouble.prototype.bzz_store = function(content, callback) {
  this.swarm.store(content, callback);
};

GethApiDouble.prototype.bzz_retrieve = function(key, callback) {
  this.swarm.retrieve(key, callback);
};

GethApiDouble.prototype.bzz_put = function(content, contentType, callback) {
  this.swarm.put(content, contentType, callback);
};

GethApiDouble.prototype.bzz_get = function(uri, callback) {
  this.swarm.get(uri, callback);
};

GethApiDouble.prototype.bzz_modify = function(content, contentHash, contentType, callback) {
  this.swarm.modify(content, contentHash, contentType, callback);
};
