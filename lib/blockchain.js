...
Blockchain.prototype.blockNumber = function() {
  return utils.bufferToInt(this.block[this.blocks.length - 1].header.number);
};
...
Blockchain.prototype.snapshot = function() {
  ...
  console.log("Saved snapshot #" + this.snapshots.length);
...
Blockchain.prototype.revert = function(snapshot_id) {
  ...
  console.log("Reverting to snapshot #" + snapshot_id);
